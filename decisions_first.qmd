...
description: "Escape the null ritual. Start from the decision you need to make, derive the data questions from it, design the study to answer them, and report findings without the lure of incredible certitude."
share:
  permalink: "https://book.martinez.fyi/decisions_first.html"
  description: "A decisions-first framework: start with the decision, not the p-value"
  linkedin: true
  email: true
  mastodon: true
---
