...
#| fig-alt: "Two scatter panels against a dashed diagonal. The LongBet panel hugs the diagonal; the aggregate panel collapses onto six horizontal bands, one per exposure."
#| fig-width: 8.5
#| fig-height: 4
