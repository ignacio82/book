...
description: "Move from predicting who will convert to identifying whom your intervention will actually move. Targeting on uplift rather than propensity, and why building the control group comes first."
share:
  permalink: "https://book.martinez.fyi/causalPropensity.html"
  description: "Causal propensity: target who you can persuade, not who converts anyway"
  linkedin: true
  email: true
  mastodon: true
---
