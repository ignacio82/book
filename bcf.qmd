...
description: "Bayesian Causal Forests separate the prognostic surface from the treatment-effect surface and condition on the propensity score, fixing BART's weaknesses for heterogeneous effects."
share:
  permalink: "https://book.martinez.fyi/bcf.html"
  description: "Bayesian Causal Forest: heterogeneous treatment effects without induced confounding"
  linkedin: true
  email: true
  mastodon: true
---
...
library(ggplot2)
df <- tibble::tibble(
  sample = 1:length(bcf_model_warmstart$sigma2_global_samples),
  sigma2_samples = bcf_model_warmstart$sigma2_global_samples
)
