...
description: "Why the Bayesian approach to linear regression suits business decisions better than OLS: a full posterior distribution over effects instead of a point estimate and a p-value."
share:
  permalink: "https://book.martinez.fyi/blm.html"
  description: "Bayesian linear regression: posteriors over effects, not just point estimates"
  linkedin: true
  email: true
  mastodon: true
---
...
The {imt} package fits a Bayesian linear model using [weakly informative
...
The {imt} package enables the creation of interactive visualizations that
