---
title: Introduction
description: "Why data does not speak for itself, and what it takes to be its voice: an introduction to causal inference and decision-focused analysis for business data scientists."
share:
  permalink: "https://book.martinez.fyi/"
  description: "Business Data Science: a guide to causal inference for data-driven decisions"
  linkedin: true
  email: true
  mastodon: true
---
...
To further assist you, I have created [Iggy](https://iggy.martinez.fyi),
an AI Data Science agent that acts as a companion to this book. Iggy is
designed to answer your data science questions using the contents of this
book as its knowledge base, providing an interactive way to explore and
