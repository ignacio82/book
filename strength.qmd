---
title: "Study Design"
description: "Power calculations, minimum detectable effects, and profit-maximizing A/B tests: how to size a study around the decision it informs rather than an arbitrary significance threshold."
share:
...
# Seeded so the Type S / Type M figures quoted below are reproducible.
# Without this the counts drift on every render, which is how the
# published numbers changed between builds.
set.seed(42)
...
run_simulations <-
  function(N,
           ...
           periods,
           threshold,
           num_cores = min(4, max(1, parallel::detectCores() - 1))) {
