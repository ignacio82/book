...
description: "Bayesian Additive Regression Trees, a non-parametric ensemble that learns non-linearities and interactions directly from data, worked through examples adding covariates and propensity scores."
share:
  permalink: "https://book.martinez.fyi/bart.html"
  description: "BART: Bayesian Additive Regression Trees for flexible causal modeling"
  linkedin: true
  email: true
  mastodon: true
---
