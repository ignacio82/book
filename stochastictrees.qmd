...
description: "BART and its causal derivatives: flexible non-parametric models that capture non-linearities and interactions without hand-specified functional forms, and the assumptions they still require."
share:
  permalink: "https://book.martinez.fyi/stochastictrees.html"
  description: "Stochastic trees: BART and its derivatives for causal inference"
  linkedin: true
  email: true
  mastodon: true
---
...
We'll explore two key models in this family: BART and Bayesian Causal Forests
(BCF). Each of these models builds upon its predecessors, offering
