...
description: "Ordinal regression with Bayesian Additive Regression Trees using the complementary log-log link, capturing non-linearities and interactions while avoiding restrictive cutpoint constraints."
share:
  permalink: "https://book.martinez.fyi/phobart.html"
  description: "Ordinal regression with BART and the cloglog link, free of cutpoint constraints"
  linkedin: true
  email: true
  mastodon: true
author:
...
<img src="img/phobart.jpeg" align="right" height="280" alt="Ordinal Regression with BART and the Cloglog Link" />
