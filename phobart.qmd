...
- **The Linear Model's Blind Spot:** The linear probit reports high posterior
  confidence that promoters increased, but **0% probability** that detractors
  increased. Because standard cumulative-link models impose monotonic global
  shifts from a single parameter, they are mathematically incapable of
  detecting simultaneous increases at both extremes. Relying on this model,
  leadership would greenlight a full 100% rollout, unaware that they are
  actively alienating newer users.
