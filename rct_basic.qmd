...
description: "Randomization is not magic. How random assignment balances observable and unobservable characteristics alike, why SUTVA is the cornerstone assumption, and when to stratify."
share:
  permalink: "https://book.martinez.fyi/rct_basic.html"
  description: "The power of randomization: why random assignment works, and when SUTVA breaks it"
  linkedin: true
  email: true
  mastodon: true
---
